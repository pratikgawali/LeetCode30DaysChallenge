...
Input: 
["FirstUnique","showFirstUnique","add","add","add","add",
	"add","showFirstUnique"]
...
public class Day28_FirstUniqueNumber {
	...
	private static class FirstUnique {
	    ...
	    private Set<Integer> repeat;

	    public FirstUnique(int[] nums) {
	        
	        unique = new LinkedHashSet<>(nums.length);
	        repeat = new LinkedHashSet<>(nums.length);
	...
	/*
		Time-complexity : O(n) for initialization & O(1) for the rest 
